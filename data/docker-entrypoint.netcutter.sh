...
: ${NEO4J_dbms_memory_heap_initial__size:=${NEO4J_dbms_memory_heap_maxSize:-"12G"}}
: ${NEO4J_dbms_memory_heap_max__size:=${NEO4J_dbms_memory_heap_maxSize:-"12G"}}
...
: ${NEO4J_causal__clustering_discovery__listen__address:=${NEO4J_causalClustering_discoveryListenAddress:-"0.0.0.0:85000"}}
: ${NEO4J_causal__clustering_discovery__advertised__address:=${NEO4J_causalClustering_discoveryAdvertisedAddress:-"$(hostname):85000"}}
: ${NEO4J_causal__clustering_transaction__listen__address:=${NEO4J_causalClustering_transactionListenAddress:-"0.0.0.0:86000"}}
: ${NEO4J_causal__clustering_transaction__advertised__address:=${NEO4J_causalClustering_transactionAdvertisedAddress:-"$(hostname):86000"}}
: ${NEO4J_causal__clustering_raft__listen__address:=${NEO4J_causalClustering_raftListenAddress:-"0.0.0.0:87000"}}
...
: ${NEO4J_causal__clustering_discovery__advertised__address:=$(hostname):85000}
: ${NEO4J_causal__clustering_transaction__listen__address:=0.0.0.0:86000}
: ${NEO4J_causal__clustering_transaction__advertised__address:=$(hostname):86000}
: ${NEO4J_causal__clustering_raft__listen__address:=0.0.0.0:87000}
: ${NEO4J_causal__clustering_raft__advertised__address:=$(hostname):87000}
